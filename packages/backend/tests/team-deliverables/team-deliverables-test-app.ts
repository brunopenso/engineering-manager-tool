...
export function buildTeamDeliverablesTestApp(options: {
  userId: string;
  roles?: UserRoleType[];
  includeAuth?: boolean;
}) {
...
export async function registerTeamDeliverablesTestRoutes(
  app: ReturnType<typeof buildTeamDeliverablesTestApp>,
) {
