...
export function buildProfileSettingsTestApp(options: {
  userId: string;
  roles?: UserRoleType[];
  includeAuth?: boolean;
}) {
...
export async function registerProfileSettingsTestRoutes(
  app: ReturnType<typeof buildProfileSettingsTestApp>,
) {
