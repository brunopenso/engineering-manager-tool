...
import {
  ...
  adminListAuthRoles,
  sampleAdminListUser,
} from '../admin-users-filters/admin-users-filters.setup.js';
import {
  buildAdminUsersTestApp,
  registerAdminUsersTestRoutes,
} from '../admin-users-filters/admin-users-test-app.js';
...
describe('admin user list profile fields', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('still returns extended UserProfile without requiring admin UI columns', async () => {
