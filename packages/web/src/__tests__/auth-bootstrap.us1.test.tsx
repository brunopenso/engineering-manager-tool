...
import { AuthApiError } from '../services/authApi.js';

const { refreshSessionMock } = vi.hoisted(() => ({
  refreshSessionMock: vi.fn(),
}));

vi.mock('../services/authApi.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../services/authApi.js')>();
  return {
    ...actual,
