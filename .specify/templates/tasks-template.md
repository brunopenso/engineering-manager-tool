...
**Tests**: The examples below include test tasks. Tests are MANDATORY - every user story and requirement MUST have automated test tasks defined and implemented before code is merged.
...
- [ ] T006 [P] Implement hierarchical DAC enforcement primitives (self + recursive descendants only)
...
- For data-visibility features, include DAC allow/deny test evidence for each story
